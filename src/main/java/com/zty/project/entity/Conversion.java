...
public class Conversion {
    private int id,sid;
    private String st_project,conversion_time,commodity_name,send_active;

    public Conversion(){
        super();
    }

    public Conversion(int id, int sid, String st_project, String conversion_time, String commodity_name, String send_active) {
        this.id = id;
        this.sid = sid;
        this.st_project = st_project;
    ...
    public String getSt_project() {
        return st_project;
    }

    public void setSt_project(String st_project) {
        this.st_project = st_project;
    }
